...
class Media {
  ...
  onResize({ screen, viewport } = {}) {
    ...
    this.plane.scale.y = (this.viewport.height * (720 * this.scale * this.itemScale)) / this.screen.height;
    this.plane.scale.x = (this.viewport.width * (520 * this.scale * this.itemScale)) / this.screen.width;
...
class App {
  constructor(
    ...
    this.onResize();
    this.createGeometry();
    this.createMedias(items, bend, textColor, borderRadius, font, spacing, itemScale);
    this.update();
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font, spacing = 2, itemScale = 1) {
    const defaultItems = [
...
export default function CircularGallery({
  ...
  }, [items, bend, textColor, borderRadius, font, fontUrl, scrollSpeed, scrollEase, spacing, itemScale]);
  return (
    <div
